...
@Component({
  selector: 'app-sidebar-dashboardadmin',
  templateUrl: './sidebar-dashboardadmin.component.html',
  styleUrls: ['./sidebar-dashboardadmin.component.css']
})
export class SidebarDashboardadminComponent {
