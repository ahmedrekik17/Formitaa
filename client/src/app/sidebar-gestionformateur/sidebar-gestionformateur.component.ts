...
@Component({
  selector: 'app-sidebar-gestionformateur',
  templateUrl: './sidebar-gestionformateur.component.html',
  styleUrls: ['./sidebar-gestionformateur.component.css']
})
export class SidebarGestionformateurComponent {
